...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedItem.remote_feed_id'
        db.alter_column(u'openreader_feeditem', 'remote_feed_id', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'FeedItem.remote_feed_id'
        db.alter_column(u'openreader_feeditem', 'remote_feed_id', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'openreader.feeditem': {
            ...
            'remote_feed_id': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
